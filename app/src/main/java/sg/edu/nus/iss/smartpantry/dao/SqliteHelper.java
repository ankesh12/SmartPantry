...
public class SqliteHelper extends SQLiteOpenHelper {
    ...
    private final String CREATE_TABLE_ITEM = "CREATE TABLE Item (ItemId INTEGER (5), ProductName STRING REFERENCES Product (productName) ON DELETE CASCADE ON UPDATE CASCADE MATCH SIMPLE, ExpiryDate DATE, Price DECIMAL (4, 2) NOT NULL ON CONFLICT ROLLBACK, PRIMARY KEY (ItemId, ProductName) ON CONFLICT ROLLBACK)";
