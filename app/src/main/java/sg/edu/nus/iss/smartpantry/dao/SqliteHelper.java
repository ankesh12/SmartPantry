...
public class SqliteHelper extends SQLiteOpenHelper {
    ...
    private final String CREATE_TABLE_ITEM = "CREATE TABLE Item (ItemId INTEGER (5), productId STRING REFERENCES Product (prodId) ON DELETE CASCADE ON UPDATE CASCADE MATCH SIMPLE, ExpiryDate DATE, Price DECIMAL (4, 2) NOT NULL ON CONFLICT ROLLBACK DEFAULT (0), PRIMARY KEY (ItemId, productId) ON CONFLICT ROLLBACK)";
