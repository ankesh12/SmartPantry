...
public class SqliteHelper extends SQLiteOpenHelper {
    ...
    private final String CREATE_TABLE_SHOPPING_LIST="CREATE TABLE "+TABLE_SHOPPING_LIST+" ("+COL_SHOPPING_LIST_NAME+" STRING PRIMARY KEY ON CONFLICT ROLLBACK, "+COL_SHOPPING_LIST_PRODUCT_NAME+" STRING NOT NULL ON CONFLICT ROLLBACK, "+COL_SHOPPING_LIST_CATEGORY_NAME+" STRING NOT NULL ON CONFLICT ROLLBACK, "+COL_SHOPPING_LIST_QTY+" INTEGER DEFAULT (1), "+COL_SHOPPING_LIST_IS_PURCHASED+" BOOLEAN DEFAULT (0), FOREIGN KEY ("+COL_SHOPPING_LIST_PRODUCT_NAME+", "+COL_SHOPPING_LIST_CATEGORY_NAME+") REFERENCES "+TABLE_PRODUCT+" ("+COL_PROD_NAME+", "+COL_PROD_CATEGORY_NAME+") ON DELETE CASCADE ON UPDATE CASCADE MATCH SIMPLE)";
